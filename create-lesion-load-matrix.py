...
def get_binary_lesion_imgs(data_dir):
    ...
    if not os.path.isfile(data_dir + "binary_imgs.npy"):
        ...
        dataset_path = data_dir + "stroke-dataset/HallymBundang_lesionmaps_24032020/"
...
def main():
    ...
    np.save(DATA_DIR + "llm/combined_lesions_load_matrix_05102020.npy", lesion_load_matrix)
    np.save(DATA_DIR + "llm/combined_atlas_region_labels_05102020.npy", region_labels)
